...
const databaseConfig = (): TypeOrmModuleOptions => ({
  ...
  port: Number(process.env.DB_PORT || process.env.DB_LOCAL_PORT), // Usar Number() para asegurar el tipo
  username: process.env.DB_USERNAME || process.env.DB_LOCAL_USERNAME,
